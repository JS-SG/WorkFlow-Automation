            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontSize: 18 }}>
                  {log.step_type === "approval" ? "✅" : log.step_type === "notification" ? "🔔" : "⚙️"}
                </span>
                <div style={{ flex: 1 }}>
          ...
          <div key={step.id} style={{ display: "flex", alignItems: "center", flexShrink: 0 }}>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6, minWidth: 80 }}>
              <div style={{ 
                ...
                background: isCompleted ? "var(--green)" : isFailed ? "var(--red)" : isCurrent ? "var(--blue)" : "var(--border)",
                color: (isCompleted || isFailed || isCurrent) ? "white" : "var(--text-3)",
                fontSize: 10, fontWeight: 700, border: "2px solid var(--bg-input)",
              ...
              <div style={{ 
                ...
                color: isCurrent ? "var(--blue)" : isCompleted ? "var(--text-1)" : "var(--text-3)",
...
export default function ExecutionPage() {
  ...
  const STATUS_META = {
    in_progress: { icon: "⏳", color: "var(--blue)", label: "In Progress" },
    completed:   { icon: "✅", color: "var(--green)", label: "Completed" },
    failed:      { icon: "❌", color: "var(--red)", label: "Failed" },
    canceled:    { icon: "⊘", color: "var(--gray)", label: "Canceled" },
    pending:     { icon: "⏸", color: "var(--yellow)", label: "Pending" },
  };
